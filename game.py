...
class SimpleGame:
    def __init__(self, game_map: Global, map_path: str,
        ...
        self.world_surface = pygame.Surface((2832, 1504), pygame.SRCALPHA)
        ...
        img1 = pygame.transform.scale(
            pygame.image.load(
                "assets/cloud1.png").convert_alpha(), (2832, 1504))
        img2 = pygame.transform.scale(
            pygame.image.load(
                "assets/cloud2.png").convert_alpha(), (2832, 1504))
        img3 = pygame.transform.scale(
            pygame.image.load(
                "assets/cloud3.png").convert_alpha(), (2832, 1504))
        img4 = pygame.transform.scale(
            pygame.image.load(
                "assets/cloud4.png").convert_alpha(), (2832, 1504))
        img5 = pygame.transform.scale(
            pygame.image.load(
                "assets/cloud5.png").convert_alpha(), (2832, 1504))

        self.bg_images = [img5, img4, img3, img2, img1]
        self.bg_frame: float = 0.0
        self.bg_speed: float = 0.35
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        new_w = int(2832 * self.zoom)
        new_h = int(1504 * self.zoom)
